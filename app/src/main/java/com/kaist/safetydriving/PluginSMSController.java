...
public class PluginSMSController extends BroadcastReceiver implements TargetController
{
	private final Context mContext;

	public PluginSMSController(Context context) {
		this.mContext = context;
	}

	public void registerSMSStatetListener() {
		mContext.registerReceiver(this, new IntentFilter("android.provider.Telephony.SMS_RECEIVED"));
	}

	public void unregisterSMSStateListener() {
